...
class MakeCalls:
    ...
    def app(self):
        st.title('Next Query Recommendation')
        predict_endpoint = 'api/v1/next_query_recommendation/predict'

        st.write('''NLP Service to recommend the next relevant query.''')  # description and instructions
